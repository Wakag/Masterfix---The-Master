...
<body>
    ...
    <div class="navbar" id="sideNavbar">
        <a href="../../Student/dashboard.php" class="nav-link">My Dashboard</a>
        <a href="../../Student/requisitions.php" class="nav-link">View Requisitions</a>
        <a href="../../Student/new-ticket.php" class="nav-link">Make a requisition</a>
