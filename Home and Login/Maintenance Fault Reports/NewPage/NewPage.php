...
<body>
    ...
    <div class="navbar" id="sideNavbar">
        <a href="../../maintenance/dashboard.php" class="nav-link">My Dashboard</a>
        <a href="../../maintenance/requisitions.php" class="nav-link">View Requisitions</a>
    ...
    <section class="top">
        ...
        <section class="charts-container">
            <div class="charts-wrapper">
                ...
                <?php include("../piechart2_2.php"); ?>

                <!-- Include piechart4.php -->
                <?php include("../piechart4_2.php"); ?>
            </div>
        </section>
