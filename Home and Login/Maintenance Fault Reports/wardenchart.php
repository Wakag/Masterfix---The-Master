...
// Assume warden is logged in and their WardenID is available
$wardenID = '0003W03'; // Replace this with the actual logged-in warden's ID

// Fetch the residence ID for the warden
$sql = "SELECT ResidenceID FROM warden WHERE WardenID = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("s", $wardenID);
$stmt->execute();
